 ...
 * physical memory is CustomGetSystemFirmwareTable API.
 *
 * see more on:
...
/*
u32 (__stdcall *CustomGetSystemFirmwareTable)(
 ...
 /*       
    switch(get_windows_platform()){
        case WIN_2003_VISTA:
        	...
        	if( !(CustomGetSystemFirmwareTable = (void *) GetProcAddress( GetModuleHandle("kernel32.dll"),
 ...
 * however the CustomGetSystemFirmwareTable API doesn't 
 ...
 * requires the use of CustomGetSystemFirmwareTable API in order to 
 ...
 * by CustomGetSystemFirmwareTable.
 *
