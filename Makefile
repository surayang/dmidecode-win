...
CFLAGS += -w -W -Wall -Wshadow -Wstrict-prototypes -Wpointer-arith -Wcast-qual \
...
CFLAGS +=  -fms-extensions -mms-bitfields -fno-exceptions \
	...
	-DNO_XMALLOC  -DMT -lKernel32 -lntdll
...
dmidecode$(EXEEXT) : dmidecode.o dmiopt.o dmioem.o dmioutput.o util.o winsmbios.o dmidecode-rc.o
	$(CC) $(LDFLAGS) dmidecode.o dmiopt.o dmioem.o dmioutput.o util.o winsmbios.o dmidecode-rc.o -o $@
...
resdir = ./resource
vpath %.rc $(resdir)
dmidecode-rc.o: dmidecode-res.rc
